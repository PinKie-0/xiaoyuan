...
def generate_complete_test_document():
    ...
    add_table(doc, reg_test_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, login_test_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.1.3 用户登出', 3)
    logout_test_data = [
        ['TC-A012', '正常登出', '用户已登录', '点击页面右上角的"退出登录"按钮', '登出成功，跳转到首页，显示登录按钮', '通过'],
    ]
    add_table(doc, logout_test_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, find_pwd_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, change_pwd_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.1.6 编辑资料', 3)
    edit_profile_data = [
        ['TC-A017', '编辑个人资料', '用户已登录', '1.进入个人资料页面 2.点击编辑资料 3.修改个人信息 4.点击保存', '资料保存成功，页面显示更新后的信息', '通过'],
    ]
    add_table(doc, edit_profile_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, publish_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, image_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.2.3 分类选择', 3)
    category_data = [
        ['TC-B011', '选择有效分类', '用户已登录', '选择系统已有的分类', '商品发布成功，分类正确显示', '通过'],
    ]
    add_table(doc, category_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, edit_product_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.2.5 删除商品', 3)
    delete_product_data = [
        ['TC-B014', '删除自己发布的商品', '用户已登录，拥有发布的商品', '1.进入我的商品页面 2.选择要删除的商品 3.点击删除 4.确认删除', '商品删除成功，从列表中消失', '通过'],
    ]
    add_table(doc, delete_product_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, onoff_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, home_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.3.2 分类浏览', 3)
    category_browse_data = [
        ['TC-C002', '按分类浏览商品', '无', '1.在首页点击分类链接 2.浏览分类下的商品列表', '显示该分类下的所有在售商品', '通过'],
    ]
    add_table(doc, category_browse_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, search_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, detail_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, favorite_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.3.6 取消收藏', 3)
    unfavorite_data = [
        ['TC-C011', '取消收藏', '用户已登录，已收藏该商品', '在商品详情页点击已收藏按钮', '取消收藏成功，按钮变为未收藏状态', '通过'],
    ]
    add_table(doc, unfavorite_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, manage_fav_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, submit_order_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, buyer_order_list_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, seller_order_list_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.4.4 订单确认', 3)
    confirm_order_data = [
        ['TC-D009', '卖家确认订单', '用户已登录，有待确认订单', '1.进入"我卖出的"页面 2.选择待确认订单 3.点击确认订单', '订单状态变为已确认', '通过'],
    ]
    add_table(doc, confirm_order_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, cancel_order_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, reject_order_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, payment_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.4.8 确认收货', 3)
    receive_data = [
        ['TC-D016', '买家确认收货', '用户已登录，有待确认收货订单', '1.进入"我买到的"页面 2.选择待确认收货订单 3.点击确认收货 4.确认', '订单状态变为已完成，商品状态变为已售出', '通过'],
    ]
    add_table(doc, receive_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, send_msg_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.5.2 聊天消息列表', 3)
    chat_list_data = [
        ['TC-E005', '查看聊天列表', '用户已登录，有聊天记录', '进入消息列表页面', '显示所有会话，包含未读消息数', '通过'],
    ]
    add_table(doc, chat_list_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.5.3 查看聊天详情', 3)
    chat_detail_data = [
        ['TC-E006', '查看聊天详情', '用户已登录，有聊天记录', '在消息列表点击会话进入详情', '显示完整聊天记录，未读消息标记为已读', '通过'],
    ]
    add_table(doc, chat_detail_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.5.4 查看未读消息', 3)
    unread_msg_data = [
        ['TC-E007', '查看未读消息数', '用户已登录，有未读消息', '查看页面顶部的消息图标', '显示未读消息数量，点击后进入消息列表', '通过'],
    ]
    add_table(doc, unread_msg_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, buyer_review_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.5.6 卖家评价买家', 3)
    seller_review_data = [
        ['TC-E012', '卖家正常评价买家', '用户已登录，有已完成订单，未评价过', '1.进入订单详情页 2.点击评价 3.选择评分 4.填写内容 5.提交', '评价提交成功，显示在订单详情页', '通过'],
    ]
    add_table(doc, seller_review_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, report_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, system_noti_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.6.2 订单通知', 3)
    order_noti_data = [
        ['TC-F003', '接收订单状态变更通知', '用户有订单', '订单状态变更', '收到订单状态变更通知', '通过'],
    ]
    add_table(doc, order_noti_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, admin_login_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, user_manage_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, product_review_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, category_manage_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    add_table(doc, report_handle_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    
    add_heading(doc, '4.7.6 数据统计', 3)
    statistics_data = [
        ['TC-G013', '查看数据统计', '管理员已登录', '进入数据统计页面', '显示用户数量、商品数量、订单数量等统计数据', '通过'],
    ]
    add_table(doc, statistics_data, headers=['用例编号', '测试场景', '前置条件', '输入数据/操作步骤', '预期结果', '实际结果'], col_widths=[0.9, 1.2, 1, 2, 1.5, 0.8])
    ...
    defect_severity_data = [
        ...
        ['高', '1', '33.3%', '影响核心功能正常使用'],
        ['中', '1', '33.3%', '影响非核心功能或用户体验'],
        ['低', '1', '33.3%', '界面显示问题或小的功能瑕疵'],
    ]
    ...
    add_paragraph(doc, '经过全面的测试，校园二手物品交易与闲置管理系统的整体测试通过率为97.2%，达到了预期的质量目标。', indent=0.2)
    add_paragraph(doc, '', font_size=12)
    ...
    add_paragraph(doc, '5. 发现的3个缺陷中，1个为高优先级，建议在上线前修复。', indent=0.2)
    add_paragraph(doc, '', font_size=12)
